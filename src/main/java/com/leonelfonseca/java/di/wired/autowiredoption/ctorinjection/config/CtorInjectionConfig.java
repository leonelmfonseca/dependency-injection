...
public class CtorInjectionConfig {
   ...
   * instantiate them, and use them to create and manage the beans defined within. This approach
   * ensures that all your beans, whether defined via @Component scanning or @Configuration
