...
public class DiQualifierMultipleBeansWiringApplication {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("This wiring approach is the best practice, as developer explicits his intention");
    System.out.println();
  ...
  private static void qualifierAnnotMultipleBeansWiring() {
    ...
    var context = new AnnotationConfigApplicationContext(QualifierAnnotMultipleBeansWiringConfig.class);
